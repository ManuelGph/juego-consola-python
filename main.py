...
def main():
    ...
    jugador = Jugador(
        nombre_jugador
    )  # traemos el jugador importandolo con el nombre que nos pase
    ...
    while enemigos:
        enemigo_actual = random.choice(enemigos)  #va agarrar uno de los 3 enemigos que hicimos y lo va poner como actual
        ...
        while enemigo_actual.salud > 0:
            ...
            if accion == "atacar":
                ...
                break #para poder salir de la estructura (while)
...
if __name__ == "__main__": #variable especial nos asegura que solo podremos ejecutar este script desde el programa principal
    main()